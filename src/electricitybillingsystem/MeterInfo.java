...
public class MeterInfo extends JFrame implements ActionListener{
   ...
   JTextField tfname,tfaddress,tfstate,tfcity,tfemail,tfphno;
   JButton next, cancel;
   JLabel lblmeter;
   ...
   MeterInfo(String meternumber){
      ...
      JLabel lblphno =new JLabel("Note");
      lblphno.setBounds(100,320,100,20);
      p.add(lblphno);
      
      JLabel lblphnos =new JLabel("By Default Bill is Calculate for 30 days only");
      lblphnos.setBounds(240,320,500,20);
      p.add(lblphnos);
