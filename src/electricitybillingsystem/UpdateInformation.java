...
{
    JTextField tfaddress,tfstate, tfcity, tfphno, tfemail;
    ...
    UpdateInformation(String meter){
        ...
        JLabel lblphon = new JLabel("Phone");
        lblphon.setBounds(30,310,100,20);
        add(lblphon);        
        
        tfphno = new JTextField("");
        tfphno.setBounds(230,310,200,20);
        add(tfphno);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == update){
            ...
            try{
              conn c=new conn();
              c.s.executeUpdate("update customer set address = '"+address+"', city = '"+city+"',state = '"+state+"', email = '"+email+"',phno = '"+phno+"' where meter_no = '"+meter+"'");
